...
/* Don't worry about the GUI implementation */
...
public class QueueDemo extends JPanel {
	...
	public QueueDemo() {
		...
		buttonPane.add(new JLabel("            Add (Enter Value, Press Enter)"));
		...
		addField.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try {
					...
					JOptionPane.showMessageDialog(QueueDemo.this, e.getMessage(), "Add error",
		...
		removeButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try {
					...
					JOptionPane.showMessageDialog(QueueDemo.this, e.getMessage(), "Removal error",
							JOptionPane.ERROR_MESSAGE);
